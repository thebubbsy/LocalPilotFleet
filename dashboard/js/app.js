  ...
  navigate(tabName) {
    ...
    case 'ddm':
      ...
      case 'itdr':
        ...
        break;
      case 'tvm':
        if (window.VulnerabilityManagementTable) window.VulnerabilityManagementTable.render();
        break;
      case 'threat-intel':
        if (window.ThreatIntelTable) window.ThreatIntelTable.render();
        break;
      ...
      case 'network-isolation':
        if (window.NetworkIsolationTable) window.NetworkIsolationTable.render();
        break;
      case 'settings':
        this.renderSettings();
        break;
